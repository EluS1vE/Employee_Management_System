...
namespace ServerLibrary.Repositories.Implementations
{
    public class UserAccountRepository(IOptions<JwtSection> config, AppDbContext appDbContext) : IUserAccount
    {
        public async Task<GeneralResponse> CreateAsync(Register user)
        {
            ...
            var checkUserRole = await appDbContext.SystemRoles.FirstOrDefaultAsync(
        ...
        public async Task<LoginResponse> RefreshTokenAsync(RefreshToken token)
        {
            ...
            if (user is null) return new LoginResponse(false, "Refresh token could not be generated vecause user not found");
            ...
            if (updateRefreshToken is null) return new LoginResponse(false, "Refresh token could net be generated because user has not signed in");
